...
import {FaciesDescriptionSmall} from '@macrostrat/column-components/src/editor/facies/description'
import {FaciesSwatch} from '@macrostrat/column-components/src/editor/facies/color-picker'
