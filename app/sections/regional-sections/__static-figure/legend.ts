...
const FaciesPatternSwatch = (props)=>{
  ...
  return h("svg", {...sz}, [
    ...
    h("rect", {fill: `url(#pattern-${id})`, stroke: '#aaa', strokeWidth: 3, ...sz})
  ])
}
...
const Legend = (props)=>{
  return h("div.legend", [
    h(SequenceLegend, {
      ...
      h(FaciesTract, {id: 'cc', lithology: 'sandstone'}, "Shoreface and nearshore sand")
    ]),
    h(SequenceLegend, {
      index: 2,
      description: "Deeper water"
    }, [
      h(FaciesTract, {id: 'fc', lithology: 'fine siliciclastic'}, "Basin muds"),
    ...
    h(SequenceLegend, {
      ...
      h(FaciesTract, {id: 'sh', lithology: 'carbonate'}, "Grainstone shoal and shoreface"),
      h(FaciesTract, {id: 'or',  lithology: 'intraclast breccia'}, "Steepened ramp slope"),
      h(FaciesTract, {id: 'mc', lithology: 'low-energy grainstone'}, "Outer ramp"),
    ])
  ])
}
