...
const wrapNavBar = function(component){
  let NavBarPage;
  return (NavBarPage = class NavBarPage extends React.Component {
    render() {
...
const route = (path, component, props={}) => h(Route, {path,component,...props});
...
const navLink = function() { return h(NavLink, ...arguments); };

var Home = () => h('div#homepage', [
